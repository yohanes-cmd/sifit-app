            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="medical-departments-carousel">
                    <div class="single-item text-center">
                        <div class="iocn-holder"><span class="flaticon-cardiology"></span></div>
                    ...
                    <div class="single-item text-center">
                        <div class="iocn-holder"><span class="flaticon-lungs"></span></div>
                        <div class="text-holder">
                    ...
                    <div class="single-item text-center">
                        <div class="iocn-holder"><span class="flaticon-vagina"></span></div>
                        <div class="text-holder">
                    ...
                    <div class="single-item text-center">
                        <div class="iocn-holder"><span class="flaticon-neurology"></span></div>
                        <div class="text-holder">
                            ...
                            <li class="active">
                                <a href="#informasi-sifit" data-toggle="tab">
                                    <div class="img-holder">
                                        ...
                                        <div class="overlay-style-one"><div class="box"><div class="content"><div class="iocn-holder"><span class="flaticon-plus-symbol"></span></div></div></div></div>
                                    </div>
                                </a>
                                <h3>Tentang SIFIT</h3>
                            </li>
...
<section class="team-area">
    <div class="container">
        ...
        <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="single-team-member">
                        <div class="img-holder">
                            ...
                            @else
                                <img src="{{ asset('frontend/images/team/1.jpg') }}" alt="{{ $product->name }}">
                            @endif
                            <div class="overlay-style">
                                <div class="box">
                                    <div class="content">
                                        ...
                                        <div class="bottom">
                                            <ul>
                                                <li><i class="fa fa-cubes" aria-hidden="true"></i> Stok: {{ $product->stock }} {{ $product->unit ?? '' }}</li>
                                                <li><a href="{{ route('frontend.obat.detail', $product->slug) }}"><i class="fa fa-eye" aria-hidden="true"></i> Lihat Detail</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="text-holder">
                                <h3><a href="{{ route('frontend.obat.detail', $product->slug) }}">{{ $product->name }}</a></h3>
                                <span>{{ $product->category ? $product->category->name : 'Obat' }}</span>
                            </div>
                        </div>
                    </div>
            ...
            @empty
                <div class="col-md-12"><p>Belum ada data obat yang dipublikasikan.</p></div>
            @endforelse
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <ul>
                    <li>
                        <div class="single-item text-center">
                            <div class="icon-holder"><span class="flaticon-medical"></span></div>
                            <h1><span class="timer" data-from="0" data-to="{{ $latestProducts->count() }}" data-speed="1500" data-refresh-interval="50">{{ $latestProducts->count() }}</span></h1>
                            <h3>Obat Terbaru</h3>
                        </div>
                    </li>
                    <li>
                        <div class="single-item text-center">
                            <div class="icon-holder"><span class="flaticon-smile"></span></div>
                            <h1><span class="timer" data-from="0" data-to="{{ $latestNews->count() }}" data-speed="1500" data-refresh-interval="50">{{ $latestNews->count() }}</span></h1>
                            <h3>Berita Terbaru</h3>
                        </div>
                    </li>
                    <li>
                        <div class="single-item text-center">
                            <div class="icon-holder"><span class="flaticon-medical-1"></span></div>
                            <h1><span class="timer" data-from="0" data-to="1" data-speed="1500" data-refresh-interval="50">1</span></h1>
                            <h3>Sistem Terintegrasi</h3>
                        </div>
                    </li>
                    <li>
                        <div class="single-item text-center">
                            <div class="icon-holder"><span class="flaticon-ribbon"></span></div>
                            <h1><span class="timer" data-from="0" data-to="3" data-speed="1500" data-refresh-interval="50">3</span></h1>
            ...
            <div class="col-md-12">
                <div class="testimonial-carousel">
                    <div class="single-testimonial-item text-center">
                        <div class="img-box">
                            <div class="img-holder"><img src="{{ asset('frontend/images/testimonial/1.png') }}" alt="Informasi Obat"></div>
                            <div class="quote-box"><i class="fa fa-info" aria-hidden="true"></i></div>
                        </div>
                        <div class="text-holder"><p>Informasi obat ditampilkan berdasarkan data yang telah dipublikasikan melalui sistem.</p></div>
                        <div class="name"><h3>Informasi Obat</h3><span>SIFIT</span></div>
                    </div>
                    <div class="single-testimonial-item text-center">
                        <div class="img-box">
                            <div class="img-holder"><img src="{{ asset('frontend/images/testimonial/2.png') }}" alt="Pencarian"></div>
                            <div class="quote-box"><i class="fa fa-search" aria-hidden="true"></i></div>
                        </div>
                        <div class="text-holder"><p>Pencarian membantu masyarakat menemukan data obat yang dibutuhkan dengan lebih cepat.</p></div>
                        <div class="name"><h3>Mudah Dicari</h3><span>SIFIT</span></div>
                    </div>
                    <div class="single-testimonial-item text-center">
                        <div class="img-box">
                            <div class="img-holder"><img src="{{ asset('frontend/images/testimonial/1.png') }}" alt="Berita"></div>
                            <div class="quote-box"><i class="fa fa-newspaper-o" aria-hidden="true"></i></div>
                        </div>
                        <div class="text-holder"><p>Berita kefarmasian terbaru dapat diakses melalui halaman berita SIFIT.</p></div>
                        <div class="name"><h3>Berita Farmasi</h3><span>SIFIT</span></div>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="single-blog-item">
                        <div class="img-holder">
                            ...
                            <div class="overlay-style-one">
                                <div class="box">
                                    <div class="content">
                                        <a href="{{ route('frontend.berita.detail', $item->slug) }}"><span class="flaticon-plus-symbol"></span></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="text-holder">
                            <a href="{{ route('frontend.berita.detail', $item->slug) }}"><h3 class="blog-title">{{ $item->title }}</h3></a>
                            <div class="text"><p>{{ \Illuminate\Support\Str::limit(strip_tags($item->content), 120) }}</p></div>
                            <ul class="meta-info">
                                <li><a href="{{ route('frontend.berita.detail', $item->slug) }}"><i class="fa fa-calendar" aria-hidden="true"></i>{{ $item->published_at ? \Carbon\Carbon::parse($item->published_at)->format('d M Y') : $item->created_at->format('d M Y') }}</a></li>
                                <li><a href="{{ route('frontend.berita.detail', $item->slug) }}"><i class="fa fa-folder-open" aria-hidden="true"></i>{{ $item->category ? $item->category->name : 'Berita' }}</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
            @empty
                <div class="col-md-12"><p>Belum ada berita yang dipublikasikan.</p></div>
            @endforelse
        </div>
    </div>
</section>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="single-item">
                                        <div class="icon-holder"><div class="icon-box"><div class="icon"><span class="flaticon-transport"></span></div></div></div>
                                        <div class="text-holder"><h3>Data Obat</h3><p>Menampilkan data obat yang telah dipublikasikan melalui sistem.</p></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="single-item">
                                        <div class="icon-holder"><div class="icon-box"><div class="icon"><span class="flaticon-drink"></span></div></div></div>
                                        <div class="text-holder"><h3>Kategori Obat</h3><p>Membantu pengguna melihat obat berdasarkan kategori yang tersedia.</p></div>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="single-item">
                                        <div class="icon-holder"><div class="icon-box"><div class="icon"><span class="flaticon-avatar"></span></div></div></div>
                                        <div class="text-holder"><h3>Berita Farmasi</h3><p>Menyediakan berita dan informasi yang dipublikasikan melalui SIFIT.</p></div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="single-item">
                                        <div class="icon-holder"><div class="icon-box"><div class="icon"><span class="flaticon-church"></span></div></div></div>
                                        <div class="text-holder"><h3>Informasi SIFIT</h3><p>Memberikan informasi mengenai SIFIT, visi misi, fitur, FAQ, dan galeri.</p></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="appointment">
                    ...
                    <form action="{{ route('frontend.obat') }}" method="GET">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="input-box">
                                    <input type="text" name="search" placeholder="Nama obat..." required>
                                </div>
                                <div class="input-box">
                                    <input type="text" value="SIFIT - Sistem Informasi Farmasi" readonly>
                                </div>
                                <button class="thm-btn bgclr-1" type="submit">Cari Obat</button>
                            </div>
                        </div>
                    </form>
                </div>
...
<section class="brand-area" style="background-image: url('/frontend/images/awards/awards-bg.jpg');">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="text-holder">
                    <div class="sec-title"><h1>Informasi Farmasi dalam Satu Sistem</h1></div>
                    <div class="text">
            ...
            <div class="col-md-6">
                <div class="awards-holder">
                    <div class="sec-title"><h1>Akses Informasi</h1></div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="single-item"><a href="{{ route('frontend.obat') }}"><img src="{{ asset('frontend/images/awards/1.png') }}" alt="Data Obat"></a></div>
                        </div>
                        <div class="col-md-6">
                            <div class="single-item"><a href="{{ route('frontend.berita') }}"><img src="{{ asset('frontend/images/awards/2.png') }}" alt="Berita SIFIT"></a></div>
                        </div>
                    </div>
                </div>
            </div>
